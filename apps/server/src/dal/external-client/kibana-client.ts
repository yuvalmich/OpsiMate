...
export class KibanaClient {
    ...
    async searchDashboardsByTag(tagName: string): Promise<DashboardResult[]> {
        try {
            ...
            const tagData: KibanaFindResponse<KibanaTagAttributes> = await tagResponse.json() as KibanaFindResponse<KibanaTagAttributes> ;
            ...
            const dashboardData: KibanaFindResponse<KibanaDashboardAttributes> = await dashboardResponse.json() as KibanaFindResponse<KibanaDashboardAttributes>;
