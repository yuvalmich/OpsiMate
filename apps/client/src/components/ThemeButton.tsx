...
export function ThemeButton({ collapsed }: ThemeButtonProps) {
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <Moon className="h-5 w-5 flex-shrink-0 absolute rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100" />
