        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 py-4">
            ...
            <div className="grid grid-cols-3 gap-4">
                <div className="col-span-2">
                    <FieldWrapper error={errors.hostname}>
                        ...
                        <Controller name="hostname" control={control} render={({ field }) => <Input id="hostname" placeholder="192.168.1.100" {...field} />} />
                    </FieldWrapper>
                </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <FieldWrapper error={errors.username}>
                  ...
                  <Controller name="username" control={control} render={({ field }) => <Input id="username" placeholder="root" {...field} />} />
              </FieldWrapper>
            ...
            {authType === 'password' && (
                <FieldWrapper error={errors.password}>
                    ...
                    <Controller name="password" control={control} render={({ field }) => <Input id="password" type="password" placeholder="Enter password" {...field} />} />
                </FieldWrapper>
            )}
            {authType === 'key' && (
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 py-4">
            ...
            <FieldWrapper error={errors.name}>
                ...
                <Controller name="name" control={control} render={({ field }) => <Input id="name" placeholder="Production Cluster" {...field} />} />
            </FieldWrapper>
            <FieldWrapper error={errors.kubeconfigPath}>
                ...
                <Controller name="kubeconfigPath" control={control} render={({ field }) => <Input id="kubeconfigPath" placeholder="~/.kube/config" {...field} />} />
            </FieldWrapper>
            <FieldWrapper error={errors.context}>
                <Label htmlFor="context">Context</Label>
                <Controller name="context" control={control} render={({ field }) => <Input id="context" placeholder="my-cluster-context" {...field} />} />
            </FieldWrapper>
            <div className="flex justify-end gap-2 pt-4">
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 py-4">
            ...
            <FieldWrapper error={errors.name}>
                ...
                <Controller name="name" control={control} render={({ field }) => <Input id="name" placeholder="AWS Production" {...field} />} />
            </FieldWrapper>
            ...
            <FieldWrapper error={errors.accessKeyId}>
                ...
                <Controller name="accessKeyId" control={control} render={({ field }) => <Input id="accessKeyId" placeholder="AKIA..." {...field} />} />
            </FieldWrapper>
            <FieldWrapper error={errors.secretAccessKey}>
                ...
                <Controller name="secretAccessKey" control={control} render={({ field }) => <Input id="secretAccessKey" type="password" {...field} />} />
            </FieldWrapper>
...
export function ProviderSidebar({ provider, onClose }: ProviderSidebarProps) {
  ...
  const renderForm = () => {
    switch (provider.type) {
        ...
        case "kubernetes":
            return <KubernetesForm onSubmit={handleFormSubmit as SubmitHandler<KubernetesFormData>} onClose={onClose} />;
        case "aws-ec2":
        case "aws-eks":
