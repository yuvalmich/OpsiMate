	...
	if (!customFields || customFields.length === 0) {
		return (
			<>
				...
				<CustomFieldModal open={showCreateModal} onOpenChange={handleCloseModal} />
			</>
		);
	}
										...
										<AlertDialog>
											...
											<AlertDialogContent>
												<AlertDialogHeader>
													...
													<AlertDialogDescription>
														Are you sure you want to delete "<b>{field.name}</b>"? This
														action cannot be undone and will remove this field from all
														services.
													</AlertDialogDescription>
												</AlertDialogHeader>
												<AlertDialogFooter>
