...
echo "Setting up OpsiMate Playground local environment..."
...
if [ ! -f docker-compose.yml ]; then
  ...
  curl -fsSL https://raw.githubusercontent.com/OpsiMate/OpsiMate/main/docker-compose.playground.yml -o docker-compose.yml
else
...
echo ""
echo "OpsiMate Playground is running!"
